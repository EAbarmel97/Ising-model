...
function graph_and_write_over_file!(dir_names :: Array{AbstractString,1}, 
    ...
    for i in eachindex(filtered_array)
        ...
        str_mean_val = "$(utilities.mean_value(aux_dir))"
        ...
        aux_graph_file_name = replace(aux_dir_name,"simulations_T_" => "magn")
