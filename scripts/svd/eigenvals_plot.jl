...
ts_matrix = SVD.create_ts_matrix(2.0;number_of_observations=100,number_of_realizations=10000)
M = SVD.centralize_matrix(ts_matrix)
SVD.plot_eigen_spectrum(AUTOMATED_EIGEN_SEPCTRUM_GRAPHS_DIR,M,2.0)

write_beta_beta_fit(0.0,3.0,2;number_of_observations=100,number_of_realizations=10000)
